      ...
      floatingActionButton: Container(
          ...
          child: FloatingActionButton(
            ...
            child: Padding(
              ...
              child: Row(children: [
                textStyle(text: 'Attach Tanker', fontSize: 13.sp,color: Colors.white),
                SizedBox(width: 10.w,),
                Image.asset(imgAssets.onboardingtruck,height: 300), 
          ],),
            ),
          )),
    );
...
void ShowAlertDialog(){
  showDialog(context: context, builder: (context){
    ...
    return AlertDialog(
      ...
      title: textStyle(text: 'Register Water Tanker', fontSize: 15.sp,fontWeight: FontWeight.bold,),
      content: Container(
        height: 200.h,
        width: 200.w,

        child: textStyle(text: 'Your Profile is not verified  yet.Please complete your registration and wait for the approval', fontSize: 15.sp,),
